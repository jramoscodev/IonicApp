...
export class ConsultaExpedienteComponent implements OnInit {
  ...
  loadDataExpedientes(datafront) {
    ...
    let urlSend = this.dataService._uriFlujo + 'nroExpedienteIntegral=' + datafront.numeroExpedienteIntegral + '&nroExpedienteInterno=' + datafront.numeroExpedienteInterno + '&nombreRazon=&fechaDesde=' + datafront.fechaDesde + "&fechaHasta=" + datafront.fechaHasta + "&estado=0&IdFlujo=3";
